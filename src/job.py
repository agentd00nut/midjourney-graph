...
def jobFromJson(j):
    ...
    job_image_root = "https://storage.googleapis.com/dream-machines-output/" + \
        j["id"]+"/"
    ...
    return Job(
        ...
        duration=j["accumulated_duration"],
        ...
        j["reference_job_id"]+"/0_"+j["reference_image_num"] +
        ".png" if j["reference_job_id"] is not None else None,
        prompt=j["prompt"],
